...
class _$HomeStateTearOff {
  ...
  _HomeState call({List<ToDo> toDoList = const []}) {
    return _HomeState(
      toDoList: toDoList,
    );
  }
...
class _$_HomeState implements _HomeState {
  const _$_HomeState({this.toDoList = const []});
  ...
  @override
  String toString() {
    return 'HomeState(toDoList: $toDoList)';
  }
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({List<ToDo> toDoList}) = _$_HomeState;
